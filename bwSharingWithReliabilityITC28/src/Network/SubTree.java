...
public class SubTree {
	 ...
	 * upon failure of the specified pm in this tree
	 * 
	 ...
	 */
	public int getActiveVms (Request r, PhysicalMachine pm)
	{
		int activeVms = 0;
		...
		for (int i=0; i<r.virtualMachinesSet.size(); i++)
		{
			...
			if (vm.pm.equals(pm))
			{
				System.out.println("request "+r.id+"vm id "+vm.id+" vm type "+vm.vmType+" pm id ");
