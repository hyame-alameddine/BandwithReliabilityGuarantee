...
public class VMsProtectionWithBandwidthGuarantee {
	 ...
	 * @throws IOException 
	 */
	public void backupToVmMappingModelTest(ArrayList<Request> requestsList,boolean shareBandwidth, boolean useShareBwModel, FileManipulation bwGainFile) throws IloException, IOException
	{
		Request request;
		ArrayList <int []> physicalMachinesAllocation;
	...
	public ArrayList<int[]> automatedTesting (String algorithm, ArrayList<int[]> randomVmsBw, Poisson poissonDistribution, int setNb, double alpha ) throws IOException, IloException
	{
		...
		{	
			vmsProtection.backupToVmMappingModelTest(vmsProtection.requests,false,false,null);		
		}
		else if(algorithm.equals("backupEmbeddingBaseline"))
		{
			vmsProtection.backupEmbeddingBaseline(20);
		}
		else
		{
